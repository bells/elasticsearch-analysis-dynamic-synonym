...
//
//    futureInputs = new DynamicSynonymFilter.PendingInput[rollBufferSize];
//    futureOutputs = new DynamicSynonymFilter.PendingOutputs[rollBufferSize];
//    for (int pos = 0; pos < rollBufferSize; pos++) {
//      futureInputs[pos] = new DynamicSynonymFilter.PendingInput();
//      futureOutputs[pos] = new DynamicSynonymFilter.PendingOutputs();
//    }
